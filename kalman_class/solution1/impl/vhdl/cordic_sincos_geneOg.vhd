...
entity cordic_sincos_geneOg_rom is 
    generic(
             dwidth     : integer := 100; 
             awidth     : integer := 4; 
             mem_size    : integer := 13
...
architecture rtl of cordic_sincos_geneOg_rom is 
...
entity cordic_sincos_geneOg is
    generic (
...
architecture arch of cordic_sincos_geneOg is
    component cordic_sincos_geneOg_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    cordic_sincos_geneOg_rom_U :  component cordic_sincos_geneOg_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
