...
#ifndef __cordic_sincos_geneOg_H__
#define __cordic_sincos_geneOg_H__
...
struct cordic_sincos_geneOg_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(cordic_sincos_geneOg_ram) {
...
SC_MODULE(cordic_sincos_geneOg) {
...
cordic_sincos_geneOg_ram* meminst;


SC_CTOR(cordic_sincos_geneOg) {
meminst = new cordic_sincos_geneOg_ram("cordic_sincos_geneOg_ram");
