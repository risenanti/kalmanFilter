...
#ifndef __filter_faddfsub_3g8j__HH__
#define __filter_faddfsub_3g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_faddfsub_3g8j) {
    ...
    SC_CTOR(filter_faddfsub_3g8j):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
