...
class mat2
{
	...
	mat2(double a1, double a2, double b1, double b2);
	mat2();
...
mat2::mat2(double a1, double a2, double b1, double b2)
{
...
mat2 mat2::inverse(void)
{
	mat2 other(this->a1,this->a2, this->b1,this->b2);
	mat2 inv;
	double scalar = (1/(other.a1*other.b2-other.a2*other.b1));
...
double mat2::getA1(void)
{
	return a1;
}

double mat2::getA2(void)
{
	return a2;
}

double mat2::getB1(void)
{
	return b1;
}
double mat2::getB2(void)
{
	return b2;
}
